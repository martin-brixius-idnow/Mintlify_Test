...
| `issuanceDate` | string | Date when credential was issued |
| `expiryDate` | string | Date when credential expires |
| `issuer` | object | Issuing authority information |
...
- Objects are mapped to ensure backward compatibility
