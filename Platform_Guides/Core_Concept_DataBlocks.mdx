...
| Attribute                      | Description                                                                                                  | Mandatory |
|--------------------------------|--------------------------------------------------------------------------------------------------------------|-----------||
| `portrait`                     | Portrait image for EUDI requirement (can be the same as `portraitUrl`).                                      | Optional  |
| `nationality`                  | Nationality information.                                                                                     | Optional  |
| `personalAdministrativeNumber` | Personal administrative number (same as SSN number?).                                                        | Optional  |
