---
title: DataBlocks
description: Unit of information produced and consumed by the workflow nodes
---

## Overview

A DataBlock is a piece of information that flow nodes create or use. Each DataBlock has a type, and that type defines what information it contains.
...
| `consent` | Indicates user consent for biometric processing; usage depends on context (headless vs SDK-driven nodes).              | Optional  |
...
| `leftOperand`          | Id of the node whose data was used as left operand.                                              | Yes       |
| `rightOperand`         | Id of the node whose data was used as right operand.                                             | Yes       |
...
```json
{
  ...
  "birthPlace": "string",
  "address": "string",
  "familyNameBirth": "string",
  "givenNameBirth": "string",
  "email": "string",
  "phoneNumber": "string",
  "sex": "string"
}
...
Short description:  
The DigitalSignals datablock is the structured output generated by the `DIGITAL_SIGNALS:v1` node and acts as a detailed receipt of the trust assessment based on email, phone and IP.
