...
| `score`   | Numerical trust score (0–100) computed by IDnow. Based on the confidence score of the third‑party provider multiplied by 100. See also: [Confidence Score](https://dev.fingerprint.com/docs/identification-accuracy-and-confidence#confidence-score). | Yes |
