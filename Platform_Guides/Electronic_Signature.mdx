---
title: QES & AES
description: Elecotronig signing with legally recognized assurance levels.
---

## Overview

Enables users to sign documents electronically with high trust. Advanced Electronic Signatures (AES) support secure, high‑volume business processes, while Qualified Electronic Signatures (QES) provide the highest legal assurance and are suitable for regulated or high‑risk agreements.
...
- **Session Management**: Interacts with the signature provider to manage the end-user signing session.  
