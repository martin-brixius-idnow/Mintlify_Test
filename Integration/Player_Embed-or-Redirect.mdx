...
|--------------------|-------------|
| **Redirect Integration** (Recommended) | Redirect users to the IDnow-hosted Player URL for a full-screen verification experience with guaranteed camera/microphone access (if permission is given by user). |
