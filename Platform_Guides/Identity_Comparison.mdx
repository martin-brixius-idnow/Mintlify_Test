...
|----------------|--------|----------|-------------|
| `leftOperand`  | String | Yes      | ID of the step that produced the first `BasicIdentity` data block  |
| `rightOperand` | String | Yes      | ID of the step that produced the second `BasicIdentity` data block |
