...
![Minimal flow with Start, a single processing Step, and an End Step.](/img/trustplatform-flow-introduction.png)
...
![IDV Step with three outcomes: verified, fraud, and failure, each leading to a dedicated End Step.](/img/2-trustplatform-idv-verdicts.png)
...
![IDV Step producing different data blocks for different verdicts (verified, fraud, failure).](/img/3-trustplatform-idv-datablocks.png)
