...
:::info
See the full list of available webhook events here: [Webhook Events →](/docs/integration/webhooks-events)
:::
...
<details>
<summary>2. Allowlist official IDnow IP ranges</summary>
...
<details>
<summary>5. Use event_id for idempotency</summary>
...
1. **Navigate to Settings**: Go to **Settings** then **Webhooks** in the IDnow dashboard.
2. **Add endpoint URL**: Enter your HTTPS endpoint URL and description.
3. **Set secret key**: Provide a secret key for authentication.
4. **Subscribe to events**: Select specific events or receive all events by default.

:::info
Configure separate endpoints for **staging**, and **live** environments.
:::
