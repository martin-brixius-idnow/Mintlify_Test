...
- **_OIDC-based authentication_**: Secure authentication using France Identité via OpenID Connect.
- **_Seamless redirection_**: Redirects users to France Identité for login and returns them post-authentication.
- **_Ready-to-use_**: No additional configuration needed for integration.
