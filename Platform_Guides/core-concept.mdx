...
![IDV Step producing different DataBlocks for different verdicts (verified, fraud, failure).](/img/3-trustplatform-idv-datablocks.png)
...
![Flow where an IDV Step creates a BasicIdentity DataBlock that is used as input for AML Screening, which in turn produces a PepAndSanctionsResults DataBlock.](/img/trustplatform-aml-screening-match-no-match-alt.png)
...
![More complex flow where verdicts define flow path and output Datablocks created](/img/trustplatform-idv-aml-basicidentity.png)
