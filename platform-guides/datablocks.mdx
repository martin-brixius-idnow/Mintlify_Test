...
A **data block** is a piece of information that flow steps create or use. Each data block has a type, and that type defines what information it contains.

The system ensures data flow consistency by:

- Tracking which data blocks exist at each step.
- Checking that each step has the data blocks it needs.
...
| Attribute   | Description                                                                                                                        | Mandatory |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `subjectId` | Identifier of the subject provided by the customer (identifier generated by IDnow is provided with the `AuthenticatorCredential`). | Optional  |
