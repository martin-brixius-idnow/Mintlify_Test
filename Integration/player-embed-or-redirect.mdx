...
const flowId = 'YOUR_FLOW_ID'; // Your flow ID
const accessToken = 'YOUR_ACCESS_TOKEN'; // Your access token
...
flow_id = 'YOUR_FLOW_ID'  # Your flow ID
...
String flowId = "YOUR_FLOW_ID"; // Your flow ID
...
window.location.href =
  'https://player-trustplatform.idnow.io/player/?session_token=' + sessionToken;
```
